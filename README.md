...
| --- | ------ | --------------------- |
| `0021` [Sparse observables with extended alphabets](0021-sparse-observable.md) | Implemented | [RFC PR](https://github.com/Qiskit/RFCs/pull/74) \| [Implementation](https://github.com/Qiskit/RFCs/issues/75) |
