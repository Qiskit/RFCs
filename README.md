...
| `0016` [SamplerV2](0016-sampler-interface.md) | Implementation in progress | [RFC PR](https://github.com/Qiskit/RFCs/pull/56/) \| [Update 1](https://github.com/Qiskit/RFCs/pull/63) \| [Implementation](https://github.com/Qiskit/qiskit/pull/11264) |
| `0015` [Extended Estimator Interface](0015-estimator-interface.md) | To be implemented | [RFC PR](https://github.com/Qiskit/RFCs/pull/51) \| [Update 1](https://github.com/Qiskit/RFCs/pull/63) \| Implementation |
